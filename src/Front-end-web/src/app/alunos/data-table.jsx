        ...
        {data?.map((data) => (
          <TableRow key={data._id}>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                  <DropdownMenuItem> <Link href={`/detalhes/${data._id}`} className='flex justify-between items-center w-full text-yellow-500'> Editar <Pen className="w-4 h-4 "/> </Link></DropdownMenuItem>
              </DropdownMenuContent>
              </DropdownMenu>
